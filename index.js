...
function createQuizSelection() {
    ...
    quizSelectionSection.innerHTML = `
        ...
        <div id="quizOptions">
            <button id="chemistryQuizButton" class="nes-btn">Chemistry Quiz</button>
            <button id="historyQuizButton" class="nes-btn">History Quiz</button>
            <button id="mathQuizButton" class="nes-btn is-primary">Math Quiz</button>
            <button id="computerScienceQuizButton" class="nes-btn">Computer Science Quiz</button>
            <button id="englishQuizButton" class="nes-btn">English Quiz</button>
            <button id="astrologyQuizButton" class="nes-btn">Astrology Quiz</button>
            <button id="animalQuizButton" class="nes-btn">Animals Quiz</button>
            <button id="literatureQuizButton" class="nes-btn">Literature Quiz</button>
            <button id="geographyQuizButton" class="nes-btn">Geography Quiz</button>
            <button id="politicsQuizButton" class="nes-btn">Politics Quiz</button>
            <button id="economicsQuizButton" class="nes-btn">Economics Quiz</button>
            <button id="philosophyQuizButton" class="nes-btn">Philosophy Quiz</button>
            <button id="psychologyQuizButton" class="nes-btn">Psychology Quiz</button>
            <button id="physicsQuizButton" class="nes-btn">Physics Quiz</button>
            <button id="musicQuizButton" class="nes-btn">Music Quiz</button>
            <button id="sportsQuizButton" class="nes-btn">Sports Quiz</button>
            <button id="artQuizButton" class="nes-btn">Art Quiz</button>
            <button id="financeQuizButton" class="nes-btn">Finance Quiz</button>
            <button id="biologyQuizButton" class="nes-btn">Biology Quiz</button>
            <button id="realEstateQuizButton" class="nes-btn">Real Estate Quiz</button>
            <button id="engineeringQuizButton" class="nes-btn">Engineering Quiz</button>
            <button id="healthCareQuizButton" class="nes-btn">Health Care Quiz</button>
            <button id="socialStudiesQuizButton" class="nes-btn">Social Studies Quiz</button>
        </div>
    `;
}
